          ...
          <div class="site-blocks-table">
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                $total = 0;
                $cnt = 0;
                echo '<form action="cart-add.php?act=delete" method="POST">';
                foreach ($_SESSION['myCart'] as $result) {
                  ...
                  <tr>
                      <td class="product-thumbnail">
                        <img src="images/' . $result[1] . '" alt="Image" class="img-fluid">
                      </td>
                      <td class="product-name">
                        <h2 class="h5 text-black">' . $result[2] . '</h2>
                      </td>
                      <td>$' . $result[3] . '</td>
                      <td>
                        <div class="input-group mb-3" style="max-width: 120px;">
                          ...
                          <input type="text" id="quantity" class="form-control text-center" value="' . $result[4] . '" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1">
                      ...
                      <td>$' . $num . '</td>
                      <td><a href="cart-add.php?act=delete&id=' . $cnt . '"><input type="button" value="X" name="delete" class="btn btn-primary btn-sm"></a></td>
                    </tr>
                      ';
                  $cnt += 1;
                } echo '</form>'; ?>

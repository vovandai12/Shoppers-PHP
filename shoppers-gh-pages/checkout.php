...
?>
<form action="cart-add.php?act=checkout" method="post">
        ...
        echo  '<div class="row mb-5">
            <div class="col-md-12">
              <div class="border p-4 rounded" role="alert">
                Returning customer? <a href="index.php">Click here</a> to login
              </div>
            </div>
          </div>';
      } ?>
        ...
        <div class="col-md-6 mb-5 mb-md-0">
          ...
          <div class="p-3 p-lg-5 border">
            <div class="form-group">
              <label for="c_country" class="text-black">Nation <span class="text-danger">*</span></label>
              <input type="text" list="datalist" id="c_country" class="form-control" name="nation">
                ...
                if ($query->rowCount() > 0) {
                  ...
                  <option value="<?php echo htmlentities($result->nation); ?>">
                    <?php $cnt = $cnt + 1; } } ?>
                </datalist>
              <!-- </select> -->
            </div>
            <div class="form-group row">
              ...
              <div class="col-md-6">
                ...
                if ($query->rowCount() > 0) {
                  foreach ($results as $result) {  ?>
                <input type="text" class="form-control" id="c_lname" name="lastName" value="<?php echo htmlentities($result->username); ?>" disabled>
                <?php $cnt = $cnt + 1; } } ?>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="collapse" id="ship_different_address">
                <div class="py-2">
                  ...
                  <div class="form-group">
                    <label for="c_diff_country" class="text-black">Nation <span class="text-danger">*</span></label>
                    <select id="c_diff_country" class="form-control">
                      <option value="1">Select a nation</option>
              ...
              <div class="p-3 p-lg-5 border">
                <table class="table site-block-order-table mb-5">
                  ...
                  <tbody>
                    ...
                    echo '<tr>
                      <td>'.$result[2].' X '.$result[4].'<strong class="mx-2">x</strong> 1</td>
                    ...
                    <tr>
                      ...
                      <td class="text-black">$<?php echo $num ?></td>
                    </tr>
                    <tr>
                      <td class="text-black font-weight-bold"><strong>Order Total</strong></td>
                      <td class="text-black font-weight-bold"><strong>$<?php echo $num ?></strong></td>
                    </tr>
                  </tbody>
                </table>
                ...
                <div class="form-group">
                  <a href="cart-add.php?act=checkout">
